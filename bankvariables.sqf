...
bankflagarray            = [mainbank, copbank,copairbaseatm, atm1, atm2, atm3, atm4,esu_atm,esu_atm2,atm5, fob_atm1,fob_atm2,fob_atm3,atm6,atm7, atm8,srt_atm,osf_atm,osf_atm_2,taki_pharm_atm, atm11, atm12, insurgent_atm , ind_fob_atm, atmpf, pmcatm, adminbank,vipatm,vipatm_1, civdonatoratm, civdonatoratm2, copdonatoratm, opfdonatoratm, inddonatoratm,atmnews];
...
drugsellarray            = [mdrugsell,cdrugsell,ldrugsell,hdrugsell,methdrugsell,organ_dealer,organ_dealer2];
GasStationArray          =
[
